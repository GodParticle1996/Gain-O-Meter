...
export default function ConfirmAccount() {
    ...
    // NOTE: After being redirected from the email, the code is passed as a query parameter which is then passed to the /verify/email route
