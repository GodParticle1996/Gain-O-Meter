  ...
  return (
    <div className="via-root to-root rounded-xl bg-gradient-to-r p-0.5">
      <div className="rounded-[10px] p-6">
        ...
        <p className="mb-6 max-w-xl text-sm dark:text-gray-100 font-normal">
          Sessions are the devices that you've used to login to Gain-O-Meter.
        ...
        {/* {isLoading ? (
          ...
          <div className="rounded-t-xl max-w-xl">
            <div>
              ...
              <p className="mb-6 text-sm dark:text-gray-100">
                You’re logged into this Gain-O-Meter account on this device and
            ...
            <div className="w-full">
              ...
              <div className="mt-4">
                <h5 className="text-base font-semibold">
                  Other Active / Inactive Sessions
                </h5>
                <ul
