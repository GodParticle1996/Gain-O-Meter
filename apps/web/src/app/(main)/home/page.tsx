  ...
  return (
    <div>
      <div className="flex max-w-3xl flex-col gap-2 mx-auto w-full md:max-w-5xl px-6 py-8">
        <h1 className="text-[28px] leading-[34px] tracking-[-0.416px] dark:text-inherit font-extrabold">
          Setup Security & Sessions
        </h1>
        <p className="text-sm dark:text-gray-100 font-normal">
          Follow the steps to activate using the Gain-O-Meter.
        </p>
      </div>
